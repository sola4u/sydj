...
class Regist(QWidget):
    ...
    def set_ui(self):
        ...
        self.diease_a_label = QLabel("直接死亡原因（a）")
        ...
        self.diease_b_label = QLabel("直接死亡原因（b）")
        ...
        self.diease_c_label = QLabel("直接死亡原因（c）")
        ...
        self.diease_d_label = QLabel("直接死亡原因（d）")
        ...
        self.other_disease_label = QLabel("其他疾病诊断")
        ...
        self.layout.addWidget(self.bnt_layout2,25,0,1,4)
