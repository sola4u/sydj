...
class Choice_Dic():
    def __init__(self):
        self.gender_list = ['NA','男','女','未知的性别','未说明的性别']
        self.race_list = ["汉族","蒙古族","回族","藏族","维吾尔族 ","苗族","彝族",
                    "壮族","布依族","朝鲜族","满族","侗族","瑶族","白族","土家族","哈尼族",
                    "哈萨克族","傣族","黎族","傈傈族 ","高山族","拉祜族","水族",
                    "东乡族","纳西族","景颇族","柯尔克孜族","土族","达斡尔族","仫佬族",
                    "羌族","布朗族","撒拉族","毛南族","仡佬族","锡伯族","阿昌族","普米族",
                    "怒族","乌孜别克族","俄罗斯族","鄂温克族","德昂族","保安族","裕固族",
                    "京族 ","塔塔尔族","独龙族","鄂伦春族" ,"赫哲族","门巴族","珞巴族",
                    "基诺族","外国血统中国籍人士","其他","不详"]
        self.id_class_list = ['身份证','户口簿','护照','军官证','驾驶证','港澳通行证','台湾通行证','其他法定有效证件']
        self.marriage_list = ['未婚','已婚','丧偶','离婚','未说明']
        self.education_list = ['研究生','大学','大专','中专','技校','高中','初中及以下']
        self.occupation_list = ['公务员','专业技术人员','职员','企业管理者','工人','农民','学生','现役军人',
