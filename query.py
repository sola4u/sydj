...
class QueryWindow(QWidget):
    ...
    def view_record(self,id):
        ...
        self.a.report_department.setCurrentIndex(int(rslt[47]))
        ...
        self.a.nation.setText(rslt[8])
        self.a.id_class.setCurrentIndex(int(rslt[9]))
        self.a.id.setText(rslt[10])
        birthday_list = self.to_pydate(rslt[11])
        self.a.birthday.setDate(QDate(birthday_list[0],birthday_list[1],birthday_list[2]))
        death_date_list = self.to_pydate(rslt[22])
        self.a.death_date.setDate(QDate(death_date_list[0],death_date_list[1],death_date_list[2]))
        self.a.age.setText(rslt[12][:-1])
        self.a.age_unit.setCurrentText(rslt[12][-1])
        self.a.marriage.setCurrentIndex(int(rslt[13]))
        self.a.education.setCurrentIndex(int(rslt[14]))
        self.a.occupation.setCurrentIndex(int(rslt[15]))
        self.a.address_now.setText(rslt[16])
        self.a.code_now.setText(str(rslt[17]))
        self.a.address_birth.setText(rslt[18])
        self.a.code_birth.setText(str(rslt[19]))
        self.a.death_location.setCurrentIndex(int(rslt[20]))
        self.a.company.setText(rslt[21])
        self.a.family.setText(rslt[23])
        self.a.family_tel.setText(rslt[24])
        self.a.family_address.setText(rslt[25])
        self.a.disease_a.setText(rslt[26])
        self.a.disease_a_time.setText(str(rslt[27]))
        self.a.disease_a_time_unit.setCurrentText(rslt[28])
        self.a.disease_b.setText(rslt[29])
        self.a.disease_b_time.setText(str(rslt[30]))
        self.a.disease_b_time_unit.setCurrentText(rslt[31])
        self.a.disease_c.setText(rslt[32])
        self.a.disease_c_time.setText(str(rslt[33]))
        self.a.disease_c_time_unit.setCurrentText(rslt[34])
        self.a.disease_d.setText(rslt[35])
        self.a.disease_d_time.setText(str(rslt[36]))
        self.a.disease_d_time_unit.setCurrentText(rslt[37])
        self.a.other_disease.setText(rslt[38])
        self.a.death_reason.setText(rslt[39])
        self.a.diagnost_department.setCurrentIndex(int(rslt[41]))
        self.a.diagnost_method.setCurrentIndex(int(rslt[42]))
        self.a.inhospital.setText(rslt[43])
        self.a.doctor.setText(rslt[44])
        regist_list = self.to_pydate(rslt[45])
        self.a.regist_date.setDate(QDate(regist_list[0],regist_list[1],regist_list[2]))
        self.a.reporter.setText(rslt[46])
        self.a.reporter.setReadOnly(True)
        self.a.backup.setText(rslt[48])
        self.a.research.setText(rslt[49])
        self.a.researcher.setText(rslt[50])
        self.a.relation.setText(rslt[51])
        self.a.researcher_address.setText(rslt[52])
        self.a.researcher_tel.setText(rslt[53])
        self.a.death_reason2.setText(rslt[54])
        research_date_list = self.to_pydate(rslt[55])
