...
class PrintWindow(QWidget):
    ...
    def  set_ui(self):
        ...
        self.save_page1_bnt = QPushButton("保存")
        ...
        # self.a = QLabel()
        # self.a.setPixmap(QPixmap('tmp.pdf'))
...
class PaintArea(QWidget):
    ...
    def draw_page1(self,event, qp):
        ...
        qp.drawText(50,128,450,23.9, Qt.AlignLeft, "行政区划代码 %s"%(self.rslt_list[1]))
        qp.drawText(450,128,310,23.9, Qt.AlignLeft, "编号：%s"%(self.rslt_list[2]))
        x = 140
        ...
        qp.drawText(115,x,144,30, Qt.AlignCenter,self.rslt_list[3])
        qp.drawText(259,x,55,30,Qt.AlignCenter,'性别')
        qp.drawText(314,x,124,30,Qt.AlignCenter,self.rslt_list[4])
        qp.drawText(438,x,56,30,Qt.AlignCenter,'民族')
        qp.drawText(494,x,84,30,Qt.AlignCenter,self.rslt_list[5])
        ...
        qp.drawText(115,x,144,65, Qt.AlignCenter,self.rslt_list[6])
        qp.drawText(259,x,55,40,Qt.AlignCenter,'证件')
        qp.drawText(259,x,55,80,Qt.AlignCenter,'号码')
        qp.drawText(314,x,124,65,Qt.AlignCenter,self.rslt_list[7])
        qp.drawText(438,x,56,65,Qt.AlignCenter,'年龄')
        qp.drawText(494,x,84,65,Qt.AlignCenter,self.rslt_list[8])
        qp.drawText(578,x,66,40,Qt.AlignCenter,'婚姻')
        qp.drawText(578,x,66,80,Qt.AlignCenter,'状况')
        qp.drawText(644,x,84,65,Qt.AlignCenter,self.rslt_list[9])
        ...
        qp.drawText(115,x,144,65, Qt.AlignCenter,self.rslt_list[10])
        qp.drawText(259,x,55,40,Qt.AlignCenter,'文化')
        qp.drawText(259,x,55,80,Qt.AlignCenter,'程度')
        qp.drawText(314,x,124,65,Qt.AlignCenter,self.rslt_list[11])
        qp.drawText(438,x,56,40,Qt.AlignCenter,'个人')
        qp.drawText(438,x,56,80,Qt.AlignCenter,'身份')
        qp.drawText(494,x,234,65,Qt.AlignCenter,self.rslt_list[12])
        ...
        qp.drawText(115,x,144,30,Qt.AlignCenter,self.rslt_list[16])
        ...
        for i in range(address_a_length%14):
            qp.drawText(314,x,180,20+30*i,Qt.AlignCenter,self.rslt_list[17][14*i:14*(i+1)])
        ...
        for i in range(address_b_length%11):
            qp.drawText(578,x,150,20+30*i,Qt.AlignCenter,self.rslt_list[18][11*i:11*(i+1)])
        ...
        qp.drawText(115,x,144,30,Qt.AlignCenter,self.rslt_list[19])
        qp.drawText(259,x,55,20,Qt.AlignCenter,'联系')
        qp.drawText(259,x,55,50,Qt.AlignCenter,'电话')
        qp.drawText(314,x,180,30,Qt.AlignCenter,self.rslt_list[20])
        qp.drawText(494,x,84,20,Qt.AlignCenter,'家属住址')
        qp.drawText(494,x,84,50,Qt.AlignCenter,'或工作单位')
        qp.drawText(578,x,150,30,Qt.AlignCenter,self.rslt_list[21])
        ...
        qp.drawText(259,x,319,30,Qt.AlignCenter,self.rslt_list[22])
        qp.drawText(578,x,150,30,Qt.AlignCenter,self.rslt_list[23])
        ...
        qp.drawText(259,x,319,30,Qt.AlignCenter,self.rslt_list[24])
        qp.drawText(578,x,150,30,Qt.AlignCenter,self.rslt_list[25])
        ...
        qp.drawText(259,x,319,30,Qt.AlignCenter,self.rslt_list[26])
        qp.drawText(578,x,150,30,Qt.AlignCenter,self.rslt_list[27])
        ...
        qp.drawText(259,x,319,30,Qt.AlignCenter,self.rslt_list[28])
        qp.drawText(578,x,150,30,Qt.AlignCenter,self.rslt_list[29])
        ...
        qp.drawText(259,x,319,30,Qt.AlignCenter,self.rslt_list[30])
        ...
        qp.drawText(115,x,379,30,Qt.AlignCenter,self.rslt_list[31])
        qp.drawText(494,x,84,20,Qt.AlignCenter,'生前主要疾病')
        qp.drawText(494,x,84,50,Qt.AlignCenter,'最高诊断依据')
        qp.drawText(578,x,150,36,Qt.AlignCenter,self.rslt_list[32])
        ...
        qp.drawText(578,x,150,30,Qt.AlignCenter,self.rslt_list[33])
        ...
        qp.drawText(259,x,235,30,Qt.AlignCenter,self.rslt_list[34])
        qp.drawText(494,x,84,30,Qt.AlignCenter,'ICD编码:')
        qp.drawRect(578,x,150,36)
        qp.drawText(578,x,150,30,Qt.AlignCenter,self.rslt_list[35])
        ...
        for i in range(research_len%55):
            qp.drawText(60,x+30*(1+i),700,36,Qt.AlignLeft,self.rslt_list[36][i*55:(i+1)*55])
        ...
        qp.drawText(115,x,100,30,Qt.AlignCenter,self.rslt_list[37])
        qp.drawText(215,x,44,20,Qt.AlignCenter,'与死者')
        qp.drawText(215,x,44,50,Qt.AlignCenter,'关系')
        qp.drawText(259,x,55,30,Qt.AlignCenter,self.rslt_list[38])
        qp.drawText(314,x,80,20,Qt.AlignCenter,'联系')
        qp.drawText(314,x,80,50,Qt.AlignCenter,'电话')
        qp.drawText(394,x,100,30,Qt.AlignCenter,self.rslt_list[39])
        qp.drawText(494,x,84,20,Qt.AlignCenter,'联系地址')
        qp.drawText(494,x,84,50,Qt.AlignCenter,'或工作单位')
        qp.drawText(578,x,150,30,Qt.AlignCenter,self.rslt_list[40])
        ...
        qp.drawText(115,x,199,30,Qt.AlignCenter,self.rslt_list[41])
        qp.drawText(314,x,80,30,Qt.AlignCenter,'被调查者签名')
        qp.drawText(494,x,84,30,Qt.AlignCenter,'调查日期')
        qp.drawText(578,x,150,30,Qt.AlignCenter,self.rslt_list[42])
...
#         qp.end()
#         # a = self.rslt_list[3] + self.rslt_list[6]
...
#         self.drawText(event, qp)
    ...
    def draw_page1_data(self,event, qp):
        ...
        qp.setFont(QFont('宋体', 9))
        qp.drawText(50,110,800,14.2, Qt.AlignLeft, self.rslt_list[0])
        qp.drawText(100,128,450,23.9, Qt.AlignLeft, "%s"%(self.rslt_list[1]))
        qp.drawText(550,128,310,23.9, Qt.AlignLeft, "%s"%(self.rslt_list[2]))
        x = 145
        qp.drawText(115,x,144,30, Qt.AlignCenter,self.rslt_list[3])
        qp.drawText(314,x,124,30,Qt.AlignCenter,self.rslt_list[4])
        qp.drawText(494,x,84,30,Qt.AlignCenter,self.rslt_list[5])
        ...
        research_len = len(self.rslt_list[36])
        for i in range(research_len%55):
            qp.drawText(60,x+30*(1+i),700,36,Qt.AlignLeft,self.rslt_list[36][i*50:(i+1)*50])
    ...
    def draw_page2(event, qp):
        pass

    def draw_page2_data(event, qp):
        pass
